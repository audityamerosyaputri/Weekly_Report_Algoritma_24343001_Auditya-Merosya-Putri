...
2. **Pemprograman**:
   - Pemprograman adalah proses penulisan, menguji, memperbaiki, dan memelihara kode agar komputer dapat memahami dan menjalankan intruksi.
3. **Perbedaan Coding dan Programming**:
   - Coding adalah proses yang fokus pada penulisan kode sesuai sintaks dari bahasa pemprograman yang digunakan.
   - Programming meliputi analisis, membuat konsep, mengimplementasikan algoritma, memecahkan masalah, dan memahami struktur data untuk merancang dan membangun program komputer.
4. **Bahasa Pemrograman C**:
   - Bahasa pemrograman merupakan kumpulan aturan sintaks dan semantik yang dipakai untuk mendefinisikan program komputer agar bisa berkomunikasi dengan baik.
   - Bahasa C adalah bahasa general-purpose(digunakan untuk program apa saja) dan imperrative(bahasa dengan perintah) yang mendukung pemrograman terstruktur dan rekusif.
   - Dibuat oleh Dennis Ritchie pada tahun 1969-1973 untuk mengembangkan sistem operasi Unix.
   - Keuntungannya: mudah memahami bahasa lain, cocok untuk pemula, bahasa terstuktur, dapat digunakan di berbagai platform, dan bersifat portable dan fleksibel.
   - Bahasa C Memiliki beberapa versi: ANSI C (C89/C90), C99, C11, dan C18.
